...
class Train:
    def __init__(self, data_file, epochs=20000, batch_size=10, Model=Model1,
                 ...
                 shuffle=False, index_col=None, test_size=50, save=True,
                 DIR=None, NAME=None, scale=False, headers=None, STD=False):
    ...
    def run(self, plot=False):
        ...
        # try:
        self.smallest_loss = 10000000000.0
        self.ave_loss = 100000000000.0
        ...
        for i in (range(self.epochs)):
            ...
            print(f"\r{i}/{self.epochs}, ave_loss: {self.ave_loss}, batch: {self.BATCH_SIZE}, Model: {self.MODEL.__name__}, h1: {self.H1}, h2: {self.H2}, h3: {self.H3}, lr: {self.learning_rate}, optim: {self.OPTIM.__name__}", end="")
            if plot:
                self.plot_loss(i)
                # self.plot_preds(i)
